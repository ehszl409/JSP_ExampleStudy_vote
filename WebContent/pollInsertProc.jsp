...
<jsp:useBean id="pMgr" class="com.cos.voteExample.Dao.PollMgr"/>
<jsp:useBean id="plBean" class="com.cos.voteExample.model.PollListBean"/>
<jsp:setProperty property="*" name="plBean"/>
<jsp:useBean id="piBean" class="com.cos.voteExample.model.PollItemBean"/>
